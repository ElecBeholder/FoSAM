        ...
        for epoch in trange(num_epochs):
            ...
            if True:
                ...
                with torch.no_grad():
                    ...
                    with open('output_lvis_640_cls_implicit_backclass_5e4_seperate.txt', 'a', encoding='utf-8') as f:
        ...
        for epoch in trange(num_epochs):
            ...
            if epoch > 0:
                ...
                for bidx, bparts in enumerate(dataloader_train.get_iterator(batch_size=batch_size, device=torch.device("cpu"), shuffle=True, xrange=trange)):
                    ...
                    global_step = global_step + 1
                    writer.add_scalar('Loss_cls', diceloss(pred_bx1KxHxW, label_bxHxW).item(), global_step)
