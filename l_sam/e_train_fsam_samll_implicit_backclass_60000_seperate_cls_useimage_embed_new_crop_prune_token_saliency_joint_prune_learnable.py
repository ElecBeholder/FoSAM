...
from l_sam.forveated_sam.foveated_sam_implicit_backclass_cls_useimage_embed_crop_prune_token_advance_res101_saliency_joint_prune_learnable import build_foveated_sam
...
if __name__ == '__main__':
    ...
    if True:
        ...
        unfreeze_parameters(efficientsam_ti_custom.saliency)
        ...
        optimizer = torch.optim.Adam(
            [
                ...
                {"params": efficientsam_ti_custom.saliency.parameters(), "lr": lr3},
            ]
        )
        ...
        for epoch in trange(num_epochs):
            ...
            if epoch > 0:
                ...
                for bidx, bparts in enumerate(dataloader_train.get_iterator(batch_size=batch_size, device=torch.device("cpu"), shuffle=True, xrange=trange)):
                    ...
                    loss.backward()
                    optimizer.step()
                    for name, param in efficientsam_ti_custom.saliency.named_parameters():
            ...
            if True:
                ...
                with torch.no_grad():
                    ...
                    with open('output_lvis_640_new_two_branch_window_20_res101_small_padding_0_prune_learnable_final.txt', 'a', encoding='utf-8') as f:
                        # print(targets.tolist(), file=f)
                        print("lvis")
                        print("mean_seg_miou", file=f)
                        print(mean_seg_miou.item(), file=f)
