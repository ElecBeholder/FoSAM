...
sam = sam_model_registry["vit_b"](checkpoint=os.path.join(preset.dpath_sam_checkpoints, r'sam_vit_b_01ec64.pth')).to(device=device)
...
if __name__ == '__main__':
    ...
    if True:
        ...
        if mode == 'lvis':
            ...
            dataset_train = DatasetLVIS('sp10000', dataset_partition='train')
            dataloader_train = CustomDataLoader(dataset_train, xrange=trange, cache=False)
            dataset_valid = DatasetLVIS('sp2000', dataset_partition='valid')
