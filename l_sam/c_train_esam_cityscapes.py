...
if __name__ == '__main__':
    ...
    torch.save(old_state_dict, os.path.join(preset.dpath_esam_weights, 'efficient_sam_vits.singlemask_train_cityscapes.pt'))
        ...
        for epoch in trange(num_epochs):
            ...
            if True:
                ...
                with torch.no_grad():
                    ...
                    with open('output_city.txt', 'a', encoding='utf-8') as f:
                        print("city", file=f)
