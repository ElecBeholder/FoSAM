...
from l_sam.forveated_sam.foveated_sam_implicit_backclass_cls_useimage_embed_crop_prune_token_advance_encoder_branch import build_foveated_sam
        ...
        for epoch in trange(num_epochs):
            ...
            if True:
                ...
                with torch.no_grad():
                    ...
                    with open('output_lvis_640_cls_implicit_backclass_1e-2_seperate_cls_useimage_embed_res18_new_2_0.1_3_advance.txt', 'a', encoding='utf-8') as f:
