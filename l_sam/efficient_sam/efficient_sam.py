...
def build_efficient_sam(img_size, encoder_patch_embed_dim, encoder_num_heads, num_multimask_outputs=3, checkpoint_state_dict=None):
    ...
    if checkpoint_state_dict is not None:
        sam.load_state_dict(checkpoint_state_dict["model"])
    return sam
