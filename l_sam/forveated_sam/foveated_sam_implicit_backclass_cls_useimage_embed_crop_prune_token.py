...
class FoveatedSam(nn.Module):
    ...
    def __init__(
        ...
        num_classes = 51
        in_channels = 258
        self.classifier = get_custom_resnet(num_classes=num_classes, in_channels=in_channels)
    ...
    def forward(
        ...
        fusion_emd = fuse_gaze_distance_encoder_output(image_embeddings, batched_points.squeeze(1).squeeze(1))
        cls_pred = self.classifier(fusion_emd)
