...
class FoveatedSam(nn.Module):
    ...
    def __init__(
        ...
        # num_classes = 51
        # in_channels = 258
        self.classifier = DualResNet(num_classes=51, base_model='resnet18', feat_dim=512)
    ...
    def forward(
        ...
        image_embeddings, points_1 = token_pruning(image_embeddings, batched_points.squeeze(1).squeeze(1), crop_size=15)
