...
class DualResNet(nn.Module):
    def __init__(self, num_classes=51, 
        ...
        if base_model == 'resnet18':
            ...
            self.resnet1 = models.resnet101(pretrained=True)
            feat_dim = 2048
        else:
        ...
        if base_model == 'resnet18':
            ...
            self.resnet2 = models.resnet101(pretrained=True)
        # 同理修改
...
class FoveatedSam(nn.Module):
    ...
    def __init__(
        ...
        # num_classes = 51
        # in_channels = 258
        self.classifier = DualResNet(num_classes=58, base_model='resnet101', feat_dim=2048)
