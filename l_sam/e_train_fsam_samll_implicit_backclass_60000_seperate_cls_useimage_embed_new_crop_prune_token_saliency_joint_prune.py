...
from l_sam.forveated_sam.foveated_sam_implicit_backclass_cls_useimage_embed_crop_prune_token_advance_res101_saliency_joint_prune import build_foveated_sam
        ...
        for epoch in trange(num_epochs):
            ...
            if True:
                ...
                with torch.no_grad():
                    ...
                    with open('output_lvis_640_new_two_branch_window_20_res101_small_padding_0_prune.txt', 'a', encoding='utf-8') as f:
                        # print(targets.tolist(), file=f)
                        print("lvis")
                        print("mean_seg_miou", file=f)
                        print(mean_seg_miou.item(), file=f)
