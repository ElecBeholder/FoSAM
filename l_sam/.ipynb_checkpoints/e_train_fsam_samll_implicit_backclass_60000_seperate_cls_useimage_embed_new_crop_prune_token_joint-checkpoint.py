...
if __name__ == '__main__':
    ...
    if True:
        ...
        #             with open('output_lvis_640_new_two_branch_window_20_res101_small_60000_use_pretrain.txt', 'a', encoding='utf-8') as f:
        ...
        for epoch in trange(num_epochs):
            ...
            if True:
                ...
                with torch.no_grad():
                    ...
                    with open('output_lvis_640_new_two_branch_window_20_res101_small_60000_joint_1024.txt', 'a', encoding='utf-8') as f:
                        # print(targets.tolist(), file=f)
                        print("lvis")
                        print("mean_seg_miou", file=f)
                        print(mean_seg_miou.item(), file=f)
