...
from l_sam.forveated_sam.foveated_sam_implicit_backclass_cls_useimage_embed_crop_prune_token_advance_res101 import build_foveated_sam
        ...
        for epoch in trange(num_epochs):
            ...
            if True:
                ...
                with torch.no_grad():
                    ...
                    with open('output_lvis_640_new_two_branch_window_20_res101.txt', 'a', encoding='utf-8') as f:
