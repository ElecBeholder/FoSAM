...
from DynamicFocus_foveal_seg_classification.lib.nn import SynchronizedBatchNorm2d as BatchNorm2d
...
class ResNetZoom_Stride1(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.conv1 = nn.Conv2d(386, 64, kernel_size=7, stride=1, padding=3,
                               bias=False)
...
class FovSimModule(nn.Module):
    def __init__(self, cfg, in_channels=386, out_channels=24):
