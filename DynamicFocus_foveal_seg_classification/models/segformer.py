...
class CustomSegformer(SegformerForSemanticSegmentation):
    ...
    def forward(self, pixel_values, return_feature_maps=True):
        ...
        # print(f'2222222 segformer encoder output shape {encoder_hidden_states[0].shape}')
        # print(f'3333333 segformer encoder output shape {encoder_hidden_states[1].shape}')
        # print(f'4444444 segformer encoder output shape {encoder_hidden_states[2].shape}')
        # print(f'5555555 segformer encoder output shape {encoder_hidden_states[3].shape}')
