              757, 758, 760, 761, 762, 766, 767, 771, 773, 774, 775, 776, 777, 780, 781, 782, 789, 790, 791, 793, 797, 798, 799, 800, 801, 802, 803, 804, 806, 807, 810, 811, 813, 814, 816, 817, 818, 819, 820, 821, 822, 827, 828, 829, 830, 831, 832, 833, 835, 836, 837, 838, 839, 840, 843, 845, 846, 847, 848, 854, 857,
              860, 863, 865, 866, 867, 870, 871, 872, 875, 876, 877, 878, 880, 881, 882, 885, 889, 891, 893, 895, 896, 898, 899, 900, 903, 904, 909, 910, 911, 912, 913, 914, 915, 916, 917, 919, 921, 922, 923, 924, 926, 927, 928, 930, 932, 933, 935, 936, 938, 940, 942, 943, 946, 947, 948, 949, 950, 951, 952, 953, 954,
              955, 957, 959, 960, 961, 962, 964, 965, 966, 967, 968, 970, 971, 973, 976, 977, 979, 980, 981, 982, 984, 986, 988, 989, 991, 993, 995, 996, 999, 1000, 1002, 1006, 1008, 1009, 1011, 1012, 1013, 1014, 1018, 1020, 1021, 1022, 1023, 1024, 1025, 1026, 1027, 1028, 1031, 1033, 1034, 1035, 1036, 1037, 1038, 1039,
              1041, 1042, 1043, 1045, 1046, 1050, 1051, 1052, 1055, 1056, 1057, 1059, 1060, 1061, 1062, 1064, 1066, 1068, 1069, 1070, 1071, 1072, 1073, 1074, 1077, 1078, 1079, 1082, 1083, 1085, 1087, 1089, 1090, 1091, 1092, 1093, 1094, 1095, 1096, 1097, 1098, 1099, 1100, 1101, 1102, 1103, 1104, 1105, 1106, 1107, 1108,
              1109, 1110, 1111, 1112, 1113, 1114, 1115, 1116, 1117, 1120, 1121, 1122, 1123, 1127, 1128, 1130, 1133, 1134, 1136, 1138, 1139, 1140, 1141, 1143, 1144, 1147, 1148, 1149, 1151, 1152, 1153, 1154, 1155, 1156, 1160, 1161, 1162, 1164, 1168, 1169, 1170, 1171, 1172, 1173, 1174, 1175, 1177, 1178, 1179, 1180, 1181,
              1182, 1183, 1184, 1185, 1186, 1187, 1188, 1189, 1190, 1191, 1192, 1194, 1195, 1196, 1197, 1198, 1200, 1201, 1202, 1203}
...
class PreprocessLVIS:
    ...
    def get_cids_monitored(self, take_num_class=None):
        ...
        fpath_cid_num_area_s = os.path.join(self.path_data_cache_lvis, 'cid_num_area_s.json')
        cid_num_area_s = []
        if os.path.exists(fpath_cid_num_area_s):
            cid_num_area_s = read_json(fpath_cid_num_area_s)
            print(f"CACHE #cid_num_area_s={len(cid_num_area_s)} fm {fpath_cid_num_area_s}")
        else:
            ...
            save_json(cid_num_area_s, fpath_cid_num_area_s)
            print(f"SAVE #cid_num_area_s={len(cid_num_area_s)} fm {fpath_cid_num_area_s}")
        ...
        # plt.hist(np.array(areas) ** 0.5, density=True, bins=50, alpha=0.25, label='total')
        # # plt.hist(np.array(take_areas) ** 0.5, density=True, bins=50, alpha=0.25, label='take')
        # plt.title("""lvis dataset histogram of objects' sqrt(area) & density""")
        # plt.ylabel('density')
    ...
    def get_info_lvis(self):
        ...
        if os.path.exists(fpath_pkl):
            ...
            id2imginfo = {img['id']: img for img in info['images']}

            new_annotations = []
            for anoid, annotation in enumerate(tqdm(annotations)):
                imageid = annotation['image_id']
                imginfo = id2imginfo[imageid]
                ...
                if os.path.exists(fpath_img):
                    ...
                    print(f'Invalid anoid={anoid} imageid={imageid} path={fpath_img}')

            info['annotations'] = new_annotations

            print(f"{len(annotations)} annotations are in LVIS {self.dataset_partition} dataset.")
            print(f"{len(new_annotations)} annotations are in COCO {self.dataset_partition} dataset.")
    ...
    def make_a_sample(self, anoid, mark: str = 'default', cidx2kidx={}):
        ...
        y_1xHPxWP = F.pad(y_1xHxW, (pad_left, pad_right, pad_top, pad_bottom))

        x_rgba_4xHPxWP[-1, :, :] = y_1xHPxWP[0, :, :]
        ...
        sent_csize = f"{640}x{640}"

        fname_S = f"{sent_catyname}_{sent_cid}_{sent_kid}_{sent_aid}_{sent_imgname}_{sent_fpos}_{sent_pad}_4x{sent_csize}.uint8.XY.png"
    ...
    def make_N_samples(self, N, marker, cids_monitored=None):
        ...
        for n in trange(N):
            ...
            try:
                ...
                print(f"target_cidx : {target_cidx}")
                print(f"self.annotations {self.annotations[aidx] if aidx is not None else None}")
...
class DatasetLVIS(AbstractDataset):
    ...
    def get_fnames_Ypt(self):
        return [fname for fname in os.listdir(self.path_data_cook_lvis_part_mark) if fname.endswith('.XY.png')]
    ...
    def __getitem__(self, index):
        ...
        XY_rgba_4xHxW = load_image(os.path.join(self.path_data_cook_lvis_part_mark, fname), mode='RGBA')
        if XY_rgba_4xHxW is None:
            return self.__getitem__(np.random.randint(len(self)))

        X_3xHxW = XY_rgba_4xHxW[:3, :, :]
        Y_1xHxW = XY_rgba_4xHxW[3:, :, :]
        # pad from original size to 640x640, with value 0

        # normalize the feature postion to 0-1 range
        F_2 = torch.Tensor([(idx_H) / self.cropH, (idx_W) / self.cropW]).to(dtype=torch.float32)
    ...
    if Skwargs.task == 'preprocess':
        ...
        for sp_train in Skwargs.sample_num:
            ...
            if not Skwargs.all_cidxs:
                ...
                class_num = int(round(np.clip(sp_train * 1203 / 1270141, 5, 50)))
...
python e_preprocess_scripts/b2_preprocess_lvis.py --task preprocess --dataset_partition train valid --sample_num 60000 --HW_size 640 --marker_prefix sp640_


python e_preprocess_scripts/b2_preprocess_lvis.py --task speed_test --dataset_partition train --sample_num 60 --HW_size 640 --marker_prefix sp640_
