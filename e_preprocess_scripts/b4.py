...
class DatasetCityScapes(AbstractDataset):
    ...
    def __getitem__(self, index):
        ...
        Y_1xHxW = load_tensor(fpath_Y).to(dtype=torch.float32)  # uint8 [0,19]
...
on local
python e_preprocess_scripts/b4_preprocess_cityscapes_rgblabel.py --task preprocess --dataset_partition train valid --sample_num 30
