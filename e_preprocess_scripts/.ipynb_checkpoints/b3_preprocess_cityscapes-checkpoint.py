...
class DatasetCityScapes(AbstractDataset):
    ...
    def __getitem__(self, index):
        ...
        F_2 = torch.Tensor([idx_H / self.cropH, idx_W / self.cropH]).to(dtype=torch.float32)
...
python e_preprocess_scripts/b3_preprocess_cityscapes.py --task preprocess --dataset_partition train valid --sample_num 100 --HW_size 1024 --marker_prefix sp1024_
