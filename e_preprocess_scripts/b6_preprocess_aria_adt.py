...
class DatasetADT(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # float32 to int64
        prototype_idx = self.prototype2id[info[K_pnm]] if K_pnm != 'ApartmentEnv' else -1
...
if __name__ == '__main__':
    ...
    """
    cd /home/hongyiz/DynamicFocus
    cd /home/hongyiz/DriverD/b_data_train/data_b_cache/aria_adt
